...
| `MM3_PUBLIC_URL` | `https://app.example.invalid` | Canonical external origin. Accepted as a same-origin source for state-changing requests behind the reverse proxy. |
